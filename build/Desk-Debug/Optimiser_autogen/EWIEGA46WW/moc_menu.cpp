...
template <> constexpr inline auto Menu::qt_create_metaobjectdata<qt_meta_tag_ZN4MenuE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "btnLinear_clicked",
        "",
        "btnMultiVariable_clicked",
        "btnGA_clicked",
        "btnConstrained_clicked",
        "btnMultiObjective_clicked",
        "btnWing_clicked",
        "btnManufacturing_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'btnLinear_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'btnMultiVariable_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'btnGA_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'btnConstrained_clicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'btnMultiObjective_clicked'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'btnWing_clicked'
        QtMocHelpers::SlotData<void()>(7, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'btnManufacturing_clicked'
...
void Menu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->btnLinear_clicked(); break;
        case 1: _t->btnMultiVariable_clicked(); break;
        case 2: _t->btnGA_clicked(); break;
        case 3: _t->btnConstrained_clicked(); break;
        case 4: _t->btnMultiObjective_clicked(); break;
        case 5: _t->btnWing_clicked(); break;
        case 6: _t->btnManufacturing_clicked(); break;
        default: ;
        }
    }
    (void)_a;
