...
public:
    ...
    void setupUi(QMainWindow *wWing)
    {
        ...
        txtCLCoeff->setObjectName("txtCLCoeff");
        ...
        txtCLOff->setObjectName("txtCLOff");
        ...
        txtCDQuad->setObjectName("txtCDQuad");
