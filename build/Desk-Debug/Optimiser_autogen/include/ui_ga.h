...
public:
    ...
    void setupUi(QMainWindow *wGA)
    {
        ...
        txtRepMut2->setObjectName("txtRepMut2");
        ...
        txtRepMut1->setObjectName("txtRepMut1");
        ...
        cmbOrder->addItem(QString());
        cmbOrder->setObjectName("cmbOrder");
        ...
        txtValues->setObjectName("txtValues");
        ...
        cmbSelOrder->addItem(QString());
        cmbSelOrder->setObjectName("cmbSelOrder");
        ...
        txtFitness->setObjectName("txtFitness");
        ...
        txtSelRank->setObjectName("txtSelRank");
