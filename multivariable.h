...
public:
    ...
    void setupUi(QMainWindow *wMultiVariable)
    {
        if (wMultiVariable->objectName().isEmpty())
            wMultiVariable->setObjectName(QString::fromUtf8("wMultiVariable"));
        ...
        txth->setObjectName(QString::fromUtf8("txth"));
        ...
        rbBFGS->setObjectName(QString::fromUtf8("rbBFGS"));

        verticalLayout->addWidget(rbBFGS);

        rbHJ = new QRadioButton(verticalLayoutWidget);
        rbHJ->setObjectName(QString::fromUtf8("rbHJ"));
